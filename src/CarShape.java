...
public class CarShape implements Icon
{
	    ...
	    {
	    	//creating an object to draw the body of the car 
	        Rectangle2D.Double body
	                = new Rectangle2D.Double(x, y + width / 6,
	                width - 1, width / 6);
	      //creating an object to draw the front and back tire
	    ...
	    public void paintIcon(Component c, Graphics g2, int x, int y) {
	        ...
	        //to draw the bottom of the front windshield
	        Point2D.Double r1
	                = new Point2D.Double(x + width / 6, y + width / 6);
	        // to draw he front of the roof
	        Point2D.Double r2
	                = new Point2D.Double(x + width / 3, y);
	        // to draw the rear of the roof
	        Point2D.Double r3
	                = new Point2D.Double(x + width * 2 / 3, y);
	        // to draw the bottom of the rear windshield
	        Point2D.Double r4
	                = new Point2D.Double(x + width * 5 / 6, y + width / 6);
	        Line2D.Double frontWindshield
	                = new Line2D.Double(r1, r2);
	        ...
	        ((Graphics2D) g2).setColor(Color.red);
	        ...
	        ((Graphics2D) g2).setColor(Color.blue);
